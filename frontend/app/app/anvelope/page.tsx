...
export default function AnvelopePage() {
  ...
  return (
    <div className="space-y-6">
      ...
      {/* TAB 3: AUDIT ISTORIC CSERÉK & PERMUTĂRI */}
      {activeTab === 'istoric' && (
        <div className="pleasant-card rounded-2xl p-6 space-y-4">
      ...
      {showAddAnvelopaModal && (
        <div className="fixed inset-0 z-50 bg-black/40 backdrop-blur-sm flex items-center justify-center p-4 overflow-y-auto" onClick={() => setShowAddAnvelopaModal(false)}>
          <div className="pleasant-card bg-white border border-morning-200 p-6 rounded-2xl w-full max-w-xl space-y-4 shadow-xl my-8" onClick={(e) => e.stopPropagation()}>
            <div className="flex items-center justify-between border-b border-morning-200 pb-3">
            ...
            <div className="flex items-center space-x-2 bg-morning-100 p-1.5 rounded-xl border border-morning-200">
              ...
              >
                📦 Din Stoc / Raktárról ({stocAnvelope.length} buc. în stoc)
              </button>
            </div>
              ...
              {modalMountMode === 'NOUA' ? (
                ...
                <div className="space-y-3 p-4 bg-morning-50 border border-morning-200 rounded-2xl">
                  <label className="text-sage-700 block font-extrabold text-sapphire-900 text-xs">
                    Selectează Anvelopă din Stoc (Raktáron lévő gumi): *
                  </label>
      ...
      {selectedPozitie && (
        <div className="fixed inset-0 z-50 bg-black/40 backdrop-blur-sm flex items-center justify-center p-4" onClick={() => setSelectedPozitie(null)}>
          <div className="pleasant-card bg-white border border-morning-200 p-6 rounded-2xl w-full max-w-md space-y-4 shadow-xl" onClick={(e) => e.stopPropagation()}>
            <div className="flex items-center justify-between border-b border-morning-200 pb-3">
      ...
      {showPermutareModal && pozitieA && pozitieB && (
        <div className="fixed inset-0 z-50 bg-black/40 backdrop-blur-sm flex items-center justify-center p-4" onClick={() => setShowPermutareModal(false)}>
          <div className="pleasant-card bg-white border border-morning-200 p-6 rounded-2xl w-full max-w-md space-y-4 shadow-xl" onClick={(e) => e.stopPropagation()}>
            <div className="flex items-center justify-between border-b border-morning-200 pb-3">
      ...
      {showConfigAxeModal && currentVehicul && (
        <div className="fixed inset-0 z-50 bg-black/40 backdrop-blur-sm flex items-center justify-center p-4" onClick={() => setShowConfigAxeModal(false)}>
          <div className="pleasant-card bg-white border border-morning-200 p-6 rounded-2xl w-full max-w-lg space-y-4 shadow-xl" onClick={(e) => e.stopPropagation()}>
            <div className="flex items-center justify-between border-b border-morning-200 pb-3">
