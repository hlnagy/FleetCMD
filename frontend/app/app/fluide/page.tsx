  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
        <div className="pleasant-card p-4 rounded-2xl flex items-center space-x-3">
      ...
      {solvingAlerta && (
        <div className="fixed inset-0 z-50 bg-black/40 backdrop-blur-sm flex items-center justify-center p-4" onClick={() => setSolvingAlerta(null)}>
